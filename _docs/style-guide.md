...
![Milan Aryal](http://placehold.it/800x400)

#### Image with caption

<figure>
  <img src="http://placehold.it/800x400" alt="Milan Aryal">
...
[Link]({{ site.url }}/docs/style-guide/#buttons){:role="button" class="btn btn-default"}
